...
export interface TranslationDict {
  ...
  settings_about_feature1: string;
  settings_about_feature2: string;
  settings_about_feature3: string;
  settings_about_feature4: string;
...
export const translations: Record<Language, TranslationDict> = {
  vi: {
    ...
    settings_subtitle: "Tùy biến ngôn ngữ, chế độ hiển thị và bảng màu sắc theo phong cách của bạn.",
    settings_language_title: "Ngôn ngữ hiển thị (Language)",
    settings_language_desc: "Chọn ngôn ngữ sử dụng xuyên suốt toàn bộ ứng dụng.",
    settings_lang_vi: "Tiếng Việt (Việt Nam)",
    settings_lang_en: "English (US)",
    settings_theme_title: "Chế độ giao diện (Theme Mode)",
    settings_theme_desc: "Chuyển đổi giữa chế độ Tối, Sáng hoặc đồng bộ theo cấu hình của hệ điều hành.",
    settings_theme_dark: "Tối (Dark)",
    settings_theme_light: "Sáng (Light)",
    settings_theme_system: "Hệ thống (System)",
    settings_theme_active_label: "Trạng thái hiển thị hiện tại:",
    settings_palette_title: "Bảng màu sắc (Color Palette)",
    settings_palette_desc: "Được tính toán động theo thuật toán Material Design 3 Expressive 2025 (MCU). Mọi thành phần nút bấm, thẻ và thanh điều hướng sẽ tự động thích ứng với màu sắc bạn chọn.",
    settings_palette_custom: "Màu tùy biến (Custom Hex)",
    settings_palette_custom_desc: "Nhập mã màu hex hoặc click biểu tượng màu để chọn màu bất kỳ.",
    ...
    settings_about_desc: "Bộ công cụ xử lý và kiểm định âm thanh studio chuyên nghiệp hoạt động 100% trên trình duyệt thông qua Web Audio API & DSP.",
    settings_about_feature1: "Không tải tệp lên máy chủ (Bảo mật riêng tư tuyệt đối)",
    settings_about_feature2: "Giao diện Material Design 3 Expressive v1.3.3",
    settings_about_feature3: "Thuật toán Color Token MCU Spec 2025",
    settings_about_feature4: "Hỗ trợ đa định dạng FLAC, WAV, MP3, AAC, OGG",

    // MusicTrimMerge
    trim_title: "Cắt & Ghép nhạc Studio",
    trim_desc: "Kéo thả hai điểm mốc để cắt chính xác từng mili-giây và ghép nối nhiều đoạn nhạc, xuất đa định dạng chất lượng cao.",
    trim_drop_title: "Chọn hoặc kéo thả tệp âm thanh vào đây",
    trim_drop_desc: "Hỗ trợ định dạng toàn cầu: WAV, FLAC, AIFF, MP3, M4A, AAC, OGG, Opus, WebM, WMA, ALAC, CAF, AU...",
    ...
    trim_queue_empty: "Chưa có đoạn nhạc nào trong danh sách. Hãy cắt một đoạn rồi bấm 'Thêm vào hàng chờ'!",
    ...
    trim_global_formats_hint: "Tương thích 100% định dạng âm thanh trên thế giới",
    trim_zoom_label: "Thu phóng sóng âm",
    trim_zoom_hint: "Phóng to để căn chỉnh điểm bắt đầu và kết thúc với độ chính xác mili-giây",
    ...
    visualizer_subtitle: "Phản hồi dải tần số âm học thời gian thực (20Hz - 20kHz)",
    ...
    lossless_desc: "Phân tích tần số để phát hiện tệp nhạc MP3 nén bị thổi phồng dung lượng thành FLAC/WAV.",
    lossless_help_title: "Chỉ số này hoạt động thế nào?",
    lossless_help_p1: "Nhạc nén (Lossy) như MP3 hay AAC thường loại bỏ triệt để các tần số cao trên 15 kHz - 16 kHz để giảm kích thước tệp. Khi một tệp MP3 được chuyển đổi giả tạo thành WAV hoặc FLAC ('upscaled/fake lossless'), biểu đồ tần số vẫn sẽ bị giới hạn nghiêm ngặt ở mốc này.",
    lossless_help_p2: "Tệp Lossless thật (100% gốc) giữ nguyên toàn bộ phổ âm thanh lên tới 20 kHz - 22 kHz mà không có bất kỳ đường cắt gắt nào.",
    lossless_drop_title: "Chọn tệp nhạc FLAC, WAV, AIFF, MP3, M4A cần kiểm tra",
    lossless_drop_desc: "Hỗ trợ tất cả định dạng âm thanh phổ biến để quét phổ tần số",
    ...
    lossless_spectrum_chart: "Biểu đồ phổ tần số (FFT Spectrum Curve)",
    lossless_check_another: "Kiểm tra bài khác",

    // TempoDetector
    tempo_title: "Đo Tempo bài hát (Tự động)",
    tempo_desc: "Tải tệp âm thanh lên để thuật toán đếm nhịp bass tự động đo chỉ số BPM (Tempo).",
    ...
    tempo_tap_desc: "Gõ liên tục vào nút bên dưới theo giai điệu bài hát để đo BPM tức thì.",
    ...
    tone_desc: "Phân tích tần số Pitch Chroma để xác định tông chính (Key/Scale) của bản nhạc.",
    tone_help_title: "Camelot System & Phối tông hòa âm là gì?",
    tone_help_p1: "Mã Camelot (ví dụ: 8B, 8A) là hệ thống đánh số mã hóa cho vòng tròn bậc năm (Circle of Fifths). Các DJ chuyên nghiệp sử dụng hệ thống này để trộn nhạc hòa âm (harmonic mixing) mượt mà mà không lo bị phô hay lệch tông.",
    tone_help_p2: "Các bài hát có mã kề nhau (ví dụ 8B có thể ghép hoàn hảo với 7B, 9B, hoặc 8A) sẽ có cấu trúc hòa âm tương thích và trộn lẫn với nhau tạo cảm giác tự nhiên nhất.",
    tone_drop_title: "Chọn tệp nhạc để dò tìm Thang âm",
    tone_drop_desc: "Thuật toán Pitch Class Profile hoạt động hoàn toàn trên client",
    ...
    tone_harmonic_desc: "Trộn các bài hát có thang âm sau để chuyển bài mượt mà và không lệch pha giai điệu:",
  ...
  en: {
    ...
    settings_subtitle: "Customize language, theme mode, and expressive dynamic color palette.",
    settings_language_title: "Language",
    settings_language_desc: "Choose the display language throughout the application.",
    settings_lang_vi: "Tiếng Việt (Vietnamese)",
    settings_lang_en: "English (US)",
    settings_theme_title: "Theme Mode",
    settings_theme_desc: "Switch between Dark, Light, or automatically adapt to your System settings.",
    settings_theme_dark: "Dark",
    settings_theme_light: "Light",
    settings_theme_system: "System",
    settings_theme_active_label: "Current resolved appearance:",
    settings_palette_title: "Color Palette",
    settings_palette_desc: "Powered dynamically by Material Design 3 Expressive 2025 algorithm (MCU). All buttons, cards, and interactive accents automatically harmonize with your selected seed color.",
    settings_palette_custom: "Custom Color (Hex)",
    settings_palette_custom_desc: "Enter a hex color code or click the swatch to pick any color.",
    ...
    settings_about_desc: "Professional studio-grade audio inspection & editing suite running 100% locally in your browser via Web Audio API & DSP.",
    settings_about_feature1: "Zero server uploads (100% client-side privacy)",
    settings_about_feature2: "Material Design 3 Expressive v1.3.3 UI",
    settings_about_feature3: "MCU Spec 2025 Dynamic Color Tokens",
    settings_about_feature4: "Supports FLAC, WAV, MP3, AAC, OGG formats",

    // MusicTrimMerge
    trim_title: "Studio Audio Trim & Merge",
    trim_desc: "Drag dual handles to trim with millisecond precision, splice multiple tracks, and export into various studio formats.",
    trim_drop_title: "Choose or drag & drop audio files here",
    trim_drop_desc: "Supports all world formats: WAV, FLAC, AIFF, MP3, M4A, AAC, OGG, Opus, WebM, WMA, ALAC, CAF, AU...",
    ...
    trim_queue_empty: "No segments in queue. Trim a selection and click 'Add selection to Merge Queue'!",
    ...
    trim_global_formats_hint: "100% compatible with global digital audio formats",
    trim_zoom_label: "Waveform Zoom",
    trim_zoom_hint: "Zoom in to align start and end points with millisecond precision",
    ...
    visualizer_subtitle: "Real-time acoustic FFT frequency response (20Hz - 20kHz)",
    ...
    lossless_desc: "Spectral frequency analysis to detect upscaled MP3 files disguised as FLAC or WAV.",
    lossless_help_title: "How does this analysis work?",
    lossless_help_p1: "Lossy compression (MP3, AAC) strips out high audio frequencies above 15 kHz - 16 kHz to shrink file size. When a low-bitrate MP3 is transcoded to WAV or FLAC ('fake/upscaled lossless'), the sharp high-frequency shelf cut-off remains permanently embedded.",
    lossless_help_p2: "True studio Lossless audio (100% authentic) preserves full harmonic energy reaching smoothly up to 20 kHz - 22 kHz without artificial brickwall filters.",
    lossless_drop_title: "Select FLAC, WAV, AIFF, MP3, M4A file to inspect",
    lossless_drop_desc: "Supports all digital audio containers for high-resolution FFT spectral scanning",
    ...
    lossless_spectrum_chart: "Frequency Power Curve (FFT Spectrum)",
    lossless_check_another: "Check another track",

    // TempoDetector
    tempo_title: "Auto Tempo & BPM Detector",
    tempo_desc: "Upload an audio file to analyze bass energy peaks and calculate accurate BPM.",
    ...
    tempo_tap_desc: "Tap rhythmically along to the beat to calculate BPM manually.",
    ...
    tone_desc: "Chroma pitch energy analysis to detect the musical root key and scale.",
    tone_help_title: "What is the Camelot System & Harmonic Mixing?",
    tone_help_p1: "The Camelot system (e.g., 8B, 8A) numbers musical keys around the Circle of Fifths. Professional DJs use this to mix tracks harmonically without dissonant key clashes.",
    tone_help_p2: "Adjacent keys on the Camelot wheel (such as 8B transitioning to 7B, 9B, or 8A) share compatible scale notes, ensuring seamless and melodic transitions.",
    tone_drop_title: "Select music file to detect key & scale",
    tone_drop_desc: "Pitch Class Profile algorithm executed entirely client-side",
    ...
    tone_harmonic_desc: "Mix tracks in the following keys for musically consonant transitions:",
